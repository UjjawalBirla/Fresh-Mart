        ...
        <div className="page-container relative z-10 flex flex-col items-center justify-between gap-6 py-0 sm:flex-row">
          <div className="max-w-xl text-center sm:text-left space-y-2 animate-rise">
            ...
            <p className="text-sm text-white/80">
              Farm-grown green vegetables, root crops and fresh salad staples picked daily.
            </p>
          </div>
      ...
      <section className="page-container space-y-6">
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
          <div className="input-field flex-1 sm:max-w-md">
            ...
            <input
              type="text"
              placeholder="Search vegetables (e.g., Tomato, Spinach, Potato)..."
              value={search}
          ...
          <div className="text-xs font-bold text-slate-500 dark:text-slate-400">
            Showing <strong className="text-market-leaf dark:text-market-lime">{filteredProducts.length}</strong> vegetables
          </div>
        </div>
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center gap-3 py-20">
            ...
            <p className="text-sm font-semibold text-slate-500">Loading fresh vegetables...</p>
          </div>
                  ...
                  <div className="flex flex-1 flex-col justify-between p-5 space-y-3">
                    <div>
                      <span className="section-label text-[10px]">
                        {product.subcategory || product.category || "Fresh Vegetable"}
                      </span>
